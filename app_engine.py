...
import os
import base64
from engine import app, extract_resume_text
...
bg_image = get_base64("flat-lay-tropical-palm-leaves-yellow-copy-space-background-summer-concept.jpg")   # 👈 apni image ka naam yaha daalo
...
if st.button("✨ Generate & Send Application"):
    ...
    if not sender_email or not job_description or not uploaded_file:
        ...
        with st.spinner("Processing Resume & Generating Email..."):
        ...
        if "email_body" in result:
            ...
            st.text_area("Email_body", result["email_body"], height=300)
